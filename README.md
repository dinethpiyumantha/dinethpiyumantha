...
Full-Stack Software Engineer with three years of experience architecting and deploying production-grade systems. I bring specialised expertise in crafting high-performance frontend architectures using React and Next.js, seamlessly integrating them with robust backends powered by Node.js, Golang, and Java. From conceptualising intuitive UI designs to managing scalable API development and cloud infrastructure, I take full ownership of the entire product lifecycle. I hold a Bachelor of Science (Honours) in Information Technology from the Sri Lanka Institute of Information Technology (SLIIT).
